export interface GetSearch {
     ...
     */
    modelTypes?: 'all' | string | string[] | 'actions' | 'boards' | 'cards' | 'members' | 'organizations' | ('actions' | 'boards' | 'cards' | 'members' | 'organizations')[];
    board?: {
        /**
         ...
         */
        fields?: 'all' | string | string[] | 'closed' | 'dateLastActivity' | 'dateLastView' | 'desc' | 'descData' | 'idOrganization' | 'invitations' | 'invited' | 'labelNames' | 'memberships' | 'name' | 'pinned' | 'powerUps' | 'prefs' | 'shortLink' | 'shortUrl' | 'starred' | 'subscribed' | 'url' | ('closed' | 'dateLastActivity' | 'dateLastView' | 'desc' | 'descData' | 'idOrganization' | 'invitations' | 'invited' | 'labelNames' | 'memberships' | 'name' | 'pinned' | 'powerUps' | 'prefs' | 'shortLink' | 'shortUrl' | 'starred' | 'subscribed' | 'url')[];
        organization?: string;
    };
    boards?: {
